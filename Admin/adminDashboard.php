...
<body>
    ...
    <section class="mx-10 my-5">
       ...
       <section class="mx-10 my-5 flex justify-center items-center">
                <h2 class="bg-white text-blue-500 text-center rounded-lg shadow-xl px-10 py-5 w-fit text-xl font-semibold">Question Paper Generator System Of <br><span class='text-red-500'> <? echo $_SESSION["instituteName"]; ?></span> </h2>
        </section>
        <section class="grid lg:grid-cols-3 md:grid-cols-2 justify-center gap-5 bg-white rounded-lg shadow-lg m-10  p-5">
            ...
            <section class="px-5 py-5 rounded-lg shadow-lg bg-blue-500 text-white text-2xl font-semibold flex justify-center items-center">
                ...
                <section>
                    ...
                    <p class="mt-0 md:-ml-7">

                        <img src="../Assets/Icons/classIcon.svg" alt="" srcset="">

                    </p>
                    <p class="md:-ml-4">Classes</p>
               </section>
               </a>
            ...
            <section class="px-5 py-5 rounded-lg shadow-lg bg-blue-500 text-white text-2xl font-semibold flex justify-center items-center">
              <a href="./addSubject.php">
                <section>
                    ...
                    <p class="md:-ml-7">Subjects</p>
                </section>
                </a>
            </section>
            <section class="px-5 py-5 rounded-lg shadow-lg bg-blue-500 text-white text-2xl font-semibold flex justify-center items-center">
                <a href="../Faculties/viewQuestions.php">
                    <section >
                        <p>
                            <?php
